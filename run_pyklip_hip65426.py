...
idir = '../HIP65426/jwst_s1s2_data_prep/' # input directory with stage 2 calibrated data
odir = '../HIP65426/pyklip_data/' # output directory for the plots and pyKLIP products
...
mstar = {'F250M': float(np.load('../HIP65426/pynrc_figs/seq_000_filt_F250M_starmag.npy')), # vegamag
         'F300M': float(np.load('../HIP65426/pynrc_figs/seq_000_filt_F300M_starmag.npy')), # vegamag
         'F356W': float(np.load('../HIP65426/pynrc_figs/seq_000_filt_F356W_starmag.npy')), # vegamag
         'F410M': float(np.load('../HIP65426/pynrc_figs/seq_000_filt_F410M_starmag.npy')), # vegamag
         'F444W': float(np.load('../HIP65426/pynrc_figs/seq_000_filt_F444W_starmag.npy')), # vegamag
         }
