...
project = u'spaceKLIP'
copyright = u'ERS-1386 Collaboration'
author = u'ERS-1386 Collaboration'
...
htmlhelp_basename = 'spaceKLIPdoc'
...
latex_documents = [
    (master_doc, 'spaceKLIP.tex', u'spaceKLIP Documentation',
     u'ERS-1386 Collaboration', 'manual'),
]
...
man_pages = [
    (master_doc, 'spaceKLIP', u'spaceKLIP Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'spaceKLIP', u'spaceKLIP Documentation',
     author, 'spaceKLIP', 'One line description of project.',
     'Miscellaneous'),
]
